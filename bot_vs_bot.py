...
class Ball():
    ...
    def display_score(self):
        pl1 = POKEFONT.render(str(bot.score), False, weis)
        pl2 = POKEFONT.render(str(bot2.score), False, weis)
...
while True:
    while bot.score < 10 and bot2.score < 10:
        ...
        for i in range(hgröse):
            pygame.draw.rect(screen, weis, (wgröse/2*gröse, i*gröse, gröse/2, gröse/2))
